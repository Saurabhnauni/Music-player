...
const music = new Audio('audio/kk_audio/1.mp3');
...
e.addEventListener('click',(el)=>{
    index=el.target.id;
    music.src=`audio/kk_audio/${index}.mp3`;
    poster_master_play.src=`photos/kk_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/kk_audio/${index}.mp3`; //providing link for song
    // title
