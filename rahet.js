...
const music = new Audio('audio/rahet_audio/1.mp3');
// music.play();
...
e.addEventListener('click',(el)=>{
    index=el.target.id;
    music.src=`audio/rahet_audio/${index}.mp3`;
    poster_master_play.src=`photos/rahet_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/rahet_audio/${index}.mp3`; //providing link for song
    // title
