...
const music = new Audio('audio/ar_audio/1.mp3');
// music.play();
...
e.addEventListener('click',(el)=>{
    index=el.target.id; 
    music.src=`audio/ar_audio/${index}.mp3`;
    poster_master_play.src=`photos/ar_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/ar_audio/${index}.mp3`; //providing link for song
    // title
