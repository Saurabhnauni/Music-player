...
const music = new Audio('audio/arijit_audio/1.mp3');
...
e.addEventListener('click',(el)=>{
    ...
    poster_master_play.src=`photos/arjit_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/arjit_audio/${index}.mp3`; //providing link for song
    // title
