...
const music = new Audio('audio/badshah_audio/1.mp3');
...
e.addEventListener('click',(el)=>{
    index=el.target.id;
    music.src=`audio/badshah_audio/${index}.mp3`;
    poster_master_play.src=`photos/badshah_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/badshah_audio/${index}.mp3`; //providing link for song
    // title
