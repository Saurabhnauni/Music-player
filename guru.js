...
const music = new Audio('audio/guru_audio/1.mp3');
...
e.addEventListener('click',(el)=>{
    index=el.target.id;
    music.src=`audio/guru_audio/${index}.mp3`;
    poster_master_play.src=`photos/guru_pho/${index}.jpg`;
    music.play();
    masterPlay.classList.remove('bi-play-fill');
    masterPlay.classList.add('bi-pause-fill');
    download_music.href=`audio/guru_audio/${index}.mp3`; //providing link for song
    // title
